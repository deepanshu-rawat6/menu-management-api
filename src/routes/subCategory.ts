...
import { createSubCategorySchema, updateSubCategorySchema } from '../schemas';
import { createSubCategory, updateSubCategory, getAllSubCategories, getSubCategoryByIdORName, getSubCategoriesByCategory } from '../controllers';
...
export default (router: express.Router) => {
     ...
     */
    router.post('/api/v1/categories/:category_id/sub-categories', validateData(createSubCategorySchema), createSubCategory, (req: Request, res: Response) => {
        logger.info('POST /api/v1/categories/:category_id/sub-categories');
        res.status(StatusCodes.OK).send({
            message: "POST /api/v1/categories/:category_id/sub-categories"
        });
    });
     ...
     *                   example: "Internal server error"
     */
    router.get('/api/v1/sub-categories', getSubCategoryByIdORName, (req: Request, res: Response) => {
        logger.info('GET /api/v1/sub-categories');
        res.status(StatusCodes.OK).send({
            message: "GET /api/v1/sub-categories"
        });
    });
     ...
     *                   example: "Internal server error"
     */
    router.get('/api/v1/sub-categories/all', getAllSubCategories, (req: Request, res: Response) => {
        logger.info('GET /api/v1/sub-catgories/all');
        res.status(StatusCodes.OK).send({
            message: "GET /api/v1/sub-categories/all"
        });
    });
     ...
     *                   example: "Internal server error"
     */
    router.get('/api/v1/categories/:category_id/sub-categories', getSubCategoriesByCategory, (req: Request, res: Response) => {
        logger.info('GET /api/v1/categories/:/category_id/sub-catgories');
        res.status(StatusCodes.OK).send({
            message: "GET /api/v1/categories/:category_id/sub-categories"
        });
    });
     ...
     *                   example: "Internal server error"
     */
    router.patch('/api/v1/categories/:category_id/sub-categories/:id', validateData(updateSubCategorySchema), updateSubCategory, (req: Request, res: Response) => {
